...
public interface FacadeMetier {
     ...
     */
    VoitureDao creerVoiture(final String numSerie, final String marque, final String model, final Couleur couleur, final List<Piece> pieces) throws BusinessException;
     ...
     */
    List<Voiture> listerVoiture() throws BusinessException;
}
