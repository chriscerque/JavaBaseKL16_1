...
public final class ConstantesView {
    ...
    public static final String SAISIR_MODEL = "Veuillez saisir la model :";
    ...
    public static final String MENU_NAME = "MaCommande";
    public static final String ERREUR_TRAITERCHOIX = "Une erreur est survenue lors du traitement de votre choix.";
    public static final String SORTIE_TRAITERCHOIX = "A bientot !";
    public static final String AJOUTER_FAMILLE_TYPE_PIECE = "Ajout des pieces : ";
    public static final String AJOUTER_TYPE_PIECE = "Choix du placement : ";
    public static final String AJOUTER_COULEUR = "Choix de la couleur : ";
