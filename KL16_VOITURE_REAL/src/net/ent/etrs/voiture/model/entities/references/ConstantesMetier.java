...
public final class ConstantesMetier {
    public static final String MSG_NUM_SERIE_NON_RENSEIGNE_EXCEPTION = String.format("Le numéro de série doit être renseigné et doit avoir 5 charactères");
    ...
    public static final String MSG_PRESENTER_DEMANDER_SAISIE_NUM_SERIE = "Veuillez saisir le numéro de série: ";
    public static final String MSG_PRESENTER_DEMANDER_SAISIE_MARQUE = "Veuillez saisir la marque: ";
    public static final String MSG_PRESENTER_DEMANDER_SAISIE_MODEL = "Veuillez saisir le model: ";
    public static final String MSG_AUCUNE_VOITURE_EXCEPTION = "Aucune voiture à afficher.";
    public static final String AFFICHAGE_INFORMATION_VOITURE = "MARQUE | Modele | Couleur | Num Serie";
    public static final String AFFICHAGE_LISTE_VOITURE = "%-20s | %-20s | %-20s | %-20s";
    public static final String MSG_VOITURE_CREATION_SUCCESS = "La voiture a bien été créée.";
    public static final String MSG_VOITURE_SUPPRESSION_SUCESS = "La voiture a bien été supprimée.";
