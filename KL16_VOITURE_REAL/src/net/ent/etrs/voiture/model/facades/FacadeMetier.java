...
public interface FacadeMetier {
     ...
     */
    Voiture creerVoiture(final String numSerie, final String marque, final String model, final Couleur couleur, final List<Piece> pieces) throws BusinessException, DaoException;
     ...
     */
    List<Voiture> listerVoiture() throws DaoException;
}
