...
public final class ConstantesMetier {
    ...
    public static final String MSG_CONSTRUCTION_PIECE_EXCEPTION = "Une erreur est survenue lors de la création de la pièce.";
    public static final String MSG_CONSTRUCTION_VOITURE_EXCEPTION = "Une erreur est survenue lors de la création de la voiture.";
