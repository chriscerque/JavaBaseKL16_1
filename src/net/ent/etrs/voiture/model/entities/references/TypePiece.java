...
public enum TypePiece {
    ...
    public String getLibelle() {
        return String.format("%s (%s | %s)", this.name(),this.familleTypePiece.getLibelle(), this.getPosition());
    }
...
//    public List<TypePiece> listerRoues(){
//        List<TypePiece> retour = new ArrayList<>();
//        for (TypePiece tp : TypePiece.values()){
//            if (tp.getFamilleTypePiece().equals(FamilleTypePiece.ROUE)){
//                retour.add(tp);
//            }
//        }
