...
public interface FacadeMetier {
     ...
     */
    Piece creerPiece(final String numSerie, final TypePiece typePiece) throws BusinessException, DaoException, net.ent.etrs.model.entities.exceptions.TypePieceException, net.ent.etrs.model.entities.exceptions.NumSerieException, net.ent.etrs.model.entities.exceptions.ConstructionPieceException, net.ent.etrs.model.entities.exceptions.PieceException;
     ...
     */
    List<Piece> ListerPiece(final String numSerieVoiture) throws BusinessException, DaoException;
     ...
     */
    Voiture creerVoiture(final String numSerie, final String marque, final String model, final Couleur couleur, final List<Piece> pieces) throws BusinessException, net.ent.etrs.model.entities.exceptions.ConstructionVoitureException;

    /**
     * Supprime la voiture de l'application.
     * @param numSerie numéro de serie de la voiture à supprimer.
     */
    void supprimerVoiture(final String numSerie) throws BusinessException, DaoException;
