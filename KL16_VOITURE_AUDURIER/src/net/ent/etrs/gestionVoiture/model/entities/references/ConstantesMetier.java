...
public final class ConstantesMetier {
    ...
    public static final String MSG_VOITURE_NULL_EXCEPTION = "La voiture doit être renseignée.";
    public static final String MSG_VOITURE_AJOUTER_LIST_PIECES_EXCEPTION = "La liste de pièce n'existe pas";
