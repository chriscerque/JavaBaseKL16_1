...
public enum FamilleTypePiece {
    ...
    public static FamilleTypePiece getByLibelle(String lib) throws FamilleTypePieceException {
        for (FamilleTypePiece type : FamilleTypePiece.values()) {
            if (type.getLibelle().equals(lib)) {
                return type;
            }
        }
        throw new FamilleTypePieceException(String.format(ConstantesMetier.MSG_FAMILLE_TYPE_PIECE_NON_TROUVE_EXCEPTION, lib));
    }
