...
public final class ConstantesMetier {
    ...
    public static final String MSG_VOITURE_MARQUE_NON_RENSEIGNE_EXCEPTION = "La marque de la voiture doit être renseigné.";
    public static final String MSG_VOITURE_MODEL_NON_RENSEIGNE_EXCEPTION = "Le modèle de la voiture doit être renseigné.";
    public static final String MSG_VOITURE_PIECE_NON_RENSEIGNE_EXCEPTION = "La pièce doit être renseigné.";
    ...
    public static final String LST_PIECE_VIDE = "La liste de pieces est vide";
