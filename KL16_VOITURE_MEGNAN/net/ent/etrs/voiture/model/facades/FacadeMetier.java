...
public interface FacadeMetier {
     ...
     */
    Piece creerPiece(final String numSerie, final TypePiece typePiece) throws BuisnessException;
...
//     */
//    List<Piece> ListerPiece(final String numSerieVoiture) throws BuisnessException;
     ...
     */
    Voiture creerVoiture(final String numSerie, final String marque, final String model, final Couleur couleur, final List<Piece> pieces) throws BuisnessException;

//    /**
//     * Supprime la voiture de l'application.
//     * @param numSerie numéro de serie de la voiture à supprimer.
//     */
//    void supprimerVoiture(final String numSerie) throws BuisnessException;
