package net.ent.etrs.voiture.view;
...
public final class ConstantesView {
    ...
    public static final String TITRE = "Ma Commande";
    public static final String AJOUT_PIECE = "Ajout de pièces : ";
    ...
    public static final String SAISIR_MODEL = "Veuillez saisir le modèle : ";
    ...
    public static final String MSG_AJOUTER_VOITURE_EXCEPTION = "Impossible d'ajouter une voiture.";
    ...
    public static final String ENTETE_PIECE_TYPE = "TYPE DE PIECE";
    public static final String ENTETE_PIECE_NUM = "NUM SERIE";
    public static final String ENTETE_VOITURE_MARQUE = "MARQUE";
    public static final String ENTETE_VOITURE_MODELE = "MODELE";
    public static final String ENTETE_VOITURE_COULEUR = "COULEUR";
    public static final String ENTETE_VOITURE_NUM = "NUM SERIE";
    public static final String SELECTIONNER_VOITURE = "Veuillez sélectionner une voiture : ";
    public static final String ESPACE = "   ";
    public static final String AUCUNE_VOITURE_SUPPR = "Aucune voiture n'a été supprimée";
    public static final String SORTIE_MENU = "0 - sortie";
