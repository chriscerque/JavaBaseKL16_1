...
public enum TypePiece {
    ...
    public String getLibelle() {
        return String.format("%s %s", this.getFamilleTypePiece().getLibelle(), this.getPosition().getLibelle());
    }
    ...
    public static List<TypePiece> listerPieceByFamille(final FamilleTypePiece familleTypePiece){
        List<TypePiece> lstTypePiece = new ArrayList<>();
        for (TypePiece typePiece : TypePiece.values()){
            if(typePiece.getFamilleTypePiece().equals(familleTypePiece)){
                lstTypePiece.add(typePiece);
            }
        }
        return lstTypePiece;
    }
