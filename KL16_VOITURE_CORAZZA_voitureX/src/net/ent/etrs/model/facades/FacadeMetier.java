...
public interface FacadeMetier {
     ...
     */
    List<Piece> ListerPiece(final String numSerieVoiture) throws BusinessException, net.ent.etrs.voiture.model.daos.exceptions.DaoException;
     ...
     */
    Voiture creerVoiture(final String numSerie, final String marque, final String model, final Couleur couleur, final List<Piece> pieces) throws BusinessException, VoitureException, NumSerieException;
