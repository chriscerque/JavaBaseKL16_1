...
public enum TypePiece {
    ...
    public String getLibelle() {
        String newLibelle = (familleTypePiece.getLibelle() + '_' + position.getLibelle());
        return newLibelle;
    }
    ...
    public static List<TypePiece> listerPieceByFamille(final FamilleTypePiece familleTypePiece){
        List<TypePiece> typePieceList = new ArrayList<>();
        for (TypePiece p: TypePiece.values()) {
            if (p.getFamilleTypePiece().equals(familleTypePiece)) {
                typePieceList.add(p);
            }
        }
        return typePieceList;
    }
}
