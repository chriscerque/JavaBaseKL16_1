...
public final class ConstantesMetier {
    ...
    public static final String MSG_NUM_SERIE_TAILLE_EXCEPTION = String.format("Le numéro de série doit contenir %d caractères.", ConstantesMetier.NUM_SERIE_TAILLE);
