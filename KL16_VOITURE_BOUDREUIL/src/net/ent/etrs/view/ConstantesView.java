...
public final class ConstantesView {
    ...
    public static final String AJOUT_PIECE_OUI_NON = "Voulez-vous ajouter une autre pièce ? (oui / non)";
    public static final String LISTER_PIECE_VIDE = "Aucune pièce à afficher.";
    public static final String DEBUT_INSERTION_PIECES = "Ajout des pièces :";
